...
<!-- Modal -->
<div class="modal fade" id="breederModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <?php echo $this->Form->create('User',array('url'=>'/breeders/new_breed','class'=>'','id'=>'breedForm')); ?>
                <div class="row">                    
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <?php echo $this->Form->control('buck',array('type'=>'select','id'=>'buck','label'=>false,'class'=>'multiselect-dropdown form-control','div'=>false,'required'=>true,'options' => array(''=>'Select Buck',$bucks)));
                        ...
                        <div class="position-relative form-group">
                            ...
                            <input type="date" id="mew_breed_model_date" name="date" max="<?php echo date('Y-m-d'); ?>" class="mb-2 form-control" onfocusout="getTaskDates('add')" 'required'>   
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="position-relative form-group">
                            ...
                            <!-- <input placeholder="default" type="text" class="mb-2 form-control" autocomplete="off" cursor: auto;"> -->
                            <?php echo $this->Form->control('doe',array('type'=>'select','id'=>'doe','label'=>false,'class'=>'multiselect-dropdown form-control','div'=>false,'required'=>true,'options' => array(''=>'Select Doe',$does))); ?>
                        </div>
                                                        ...
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                ...
                                                                <div class="widget-content-left">
                                                                    ...
                                                                    <div class="widget-subheading"><i id="new_breed_model_task_date_<?php echo $default_task->id; ?>"></i>
