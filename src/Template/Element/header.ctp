            ...
            <div class="app-header__menu">
                ...
                <div class="app-header-right">
                        ...
                        <div class="widget-content p-0">
                            <div class="widget-content-wrapper">
                                ...
                                <div class="widget-content-left  ml-3 header-user-info">
                                    <div class="widget-heading"> <?php echo $sess['name']; ?> </div>
                                    <div class="widget-subheading"> <?php echo $sess['email']; ?> </div>
                                </div>
                    ...
                    <div class="header-btn-lg">
                        ...
                        <?php echo $this->Html->link('<button type="button" class="hamburger hamburger--elastic">
                            <span class="hamburger-box">
                                <span class="lnr-power-switch" style="font-size:40px;color: #0F52BA;"></span>
                            </span>
                        </button>',array('controller'=>'users','action'=>'logout'),array('escape'=>false)); ?>
                    </div>        </div>
            </div>
        </div>