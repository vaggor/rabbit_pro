<div class="app-main__inner">
                        ...
                        <div class="main-card mb-3 card">
                            <div class="card-body">
                                <?php echo $this->Form->create('User',array('url'=>'/breeders/printCageCard','class'=>'')); ?>
                                <button type="submit" class="btn btn-primary" id="printMultipleCageCardSubmit_Btn" style="margin-bottom: 10px;">Print multiple cage card</button>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="custom-checkbox custom-control">
                                                <input type="checkbox" name="print[]" id="<?php echo h($data->id); ?>" value="<?php echo h($data->id); ?>" class="custom-control-input">
                                        ...
                                        <td><?php echo $this->Html->link(h($data->name),array('controller'=>'breeders','action'=>'view',h($data->id))); ?></td>
                                        ...
                                        <th>
                                            <div class="mb-2 mr-2 btn-group">
                                                ...
                                                <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right" style="">
                                                    ...
                                                    <?php echo $this->Html->link('<button type="button" tabindex="0" class="dropdown-item"><li class="fa fa-print" style="padding-right:5px;"></li> Print Cage Card</button>',array('controller'=>'breeders','action'=>'print_cage_card',h($data->id)),array('escape'=>false,'target'=>'_blank')); ?>
                                                    ...
                                                    <button type="button" tabindex="0" class="dropdown-item" data-toggle="modal" data-target="#newWeightModal" onclick="setBreederIdForWeight(<?php echo h($data->id); ?>)"><li class="fa fa-balance-scale" style="padding-right:5px;"></li> Record weight</button>
