...
<!-- Mirrored from demo.dashboardpack.com/architectui-html-pro/components-modals.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 Jul 2020 09:00:28 GMT -->
...
<body>
                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Modals
                                    <div class="page-title-subheading">Wide selection of modal dialogs styles and animations available.</div>
                                </div>
                            </div>
    ...
    <?php echo $this->Html->script(array('main.d810cf0ae7f39f28f336')); ?>
</body>
