...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="/rabbit_pro/app/img/images/favicon.png">
    <meta name="viewport"
...
<?php echo $this->Html->css(array('main.d810cf0ae7f39f28f336','custom')); ?>
</head>
<body>
    <div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
        <?php echo $this->element('header'); ?>
            ...
            <div class="app-sidebar sidebar-shadow">
                ...
                </div>    <?php echo $this->element('menu'); ?>
...
<!-- Modal -->
<?php echo $this->element('models/new_breeder_model');
echo $this->element('models/new_package_item_model');
echo $this->element('models/edit_package_item_model');
echo $this->element('models/edit_breeder_model');
echo $this->element('models/breed_model');
echo $this->element('models/record_birth_model');
echo $this->element('models/edit_birth_model');
echo $this->element('models/sell_breeder_model');
echo $this->element('models/dead_breeder_model');
echo $this->element('models/task_model');
echo $this->element('models/edit_breed_plan_model');
echo $this->element('models/new_task_model');
echo $this->element('models/edit_task_model');
echo $this->element('models/new_ledger_model');
echo $this->element('models/edit_ledger_model');
echo $this->element('models/new_weight_model');
echo $this->element('models/change_password_model');
 ?>